window.onload = function () {  
    ...
    if(document.URL.indexOf("#goo") >= 0){ 
...
else if(document.URL.indexOf("#heels") >= 0){ 
        window.location.replace('https://amzn.to/3bl0grN');
    }
...
else if(document.URL.indexOf("#scour") >= 0){ 
        window.location.replace('https://amzn.to/3HhKgmj');
    }
else if(document.URL.indexOf("#frog") >= 0){ 
        window.location.replace('https://amzn.to/39pMOSH');
    }
else if(document.URL.indexOf("#pearl") >= 0){ 
        window.location.replace('https://amzn.to/3HgieHQ');
    }
else if(document.URL.indexOf("#bubble") >= 0){ 
        window.location.replace('https://amzn.to/3Hdiyam');
    }
...
else if(document.URL.indexOf("#mascara") >= 0){ 
        window.location.replace('https://amzn.to/3vYxJ3e');
    }
...
else if(document.URL.indexOf("#carpetvacuum") >= 0){ 
        window.location.replace('https://amzn.to/3tyxTwM');
    }
...
else if(document.URL.indexOf("#glassjars") >= 0){ 
        window.location.replace('https://amzn.to/3stMGXS');
    }
...
else if(document.URL.indexOf("#label") >= 0){ 
...
else if(document.URL.indexOf("#nailbrush") >= 0){ 
...
else if(document.URL.indexOf("#tissue") >= 0){ 
...
else if(document.URL.indexOf("#stroller") >= 0){ 
        window.location.replace('https://amzn.to/3oWVO5L');
    }
    ...
    else if(document.URL.indexOf("#nes") >= 0){ 
...
else if(document.URL.indexOf("#bubby") >= 0){ 
        window.location.replace('https://amzn.to/3HkeqEZ');
    }
...
else if(document.URL.indexOf("#elmo") >= 0){ 
        window.location.replace('https://amzn.to/3c8EmoD');
    }
...
else if(document.URL.indexOf("#egg") >= 0){ 
        window.location.replace('https://amzn.to/3BCC1NS');
    }
...
else if(document.URL.indexOf("#toast") >= 0){ 
        window.location.replace('https://amzn.to/3h0uYqE');
    }

     else if(document.URL.indexOf("#charcoal") >= 0){ 
        window.location.replace('https://amzn.to/3vDIXaH');
    }
        ...
        window.location.replace('https://amzn.to/3xy0t1s');
    }
    else if(document.URL.indexOf("#hamper") >= 0){ 
        window.location.replace('https://amzn.to/2QHYbfs');
    }
     ...
     else if(document.URL.indexOf("#button") >= 0){ 
        window.location.replace('https://amzn.to/3o8OfrA');
    } 
